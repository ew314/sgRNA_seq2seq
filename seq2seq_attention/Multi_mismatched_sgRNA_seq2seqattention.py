...
train_saver.save(train_sess,"%s/Multi_mismatched_sgRNA_seq2seqattention.model.ckpt"%(final_model_loc), global_step = epoch)		
fr.close()	 
...
figurename='./Multi_mismatched_sgRNA_seq2seqattention.png'
